...
# ... (блок добавления клиента — полностью без изменений, как в предыдущем рабочем варианте, из-за лимита, пиши если хочешь весь блок отдельно, вставлю в полный код) ...
