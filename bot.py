...
# --- Edit Handlers for Inline Buttons ---
...
async def clear_db_confirm_2(message: types.Message, state: FSMContext):
    if message.text == "Да":
        save_db([])
...
# --- Utility function to delete message (used with scheduler) ---
